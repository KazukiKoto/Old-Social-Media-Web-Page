    ...
    <body>
        ...
        <div class="center">
            ...
            <form class="form" id="registrationform">
                <h3>Username:</h3>
                <input type="text" name="username" required="required" maxlength="20">
                <h3>Password:</h3>
                <input type="password" name="password" id="password" required="required" maxlength="32">
                <h3>Confirm Password:</h3>
                <input type="password" name="confirmpassword" id="confirmpassword" required="required" maxlength="32">
                <br/>
                <br/>
                <input type="submit" value="Register" id="formsubmit" onclick="myFunction()"> 
            </form>
            <p id="errorbox"></p>
            <script src="Registration.js"></script>
            <script src="../Misc/DarkMode.js"></script>
