...
<html>
    ...
    <body>
        <div class="center">
            ...
            <hr/>
            <form class="newpostform" id="newpostform" action="NewPostDAO.php" method="post">
                <input type="text" placeholder="Title..." id="newposttitle" name="newposttitle" required="required"><br/>
                <input type="text" placeholder="Text..." id="newposttext" name="newposttext" required="required"><br/>
                <input type="file" id="newpostimage" name="newpostimage" accept="image/"><br/>
